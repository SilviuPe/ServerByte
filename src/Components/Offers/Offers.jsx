...
function Mission() {
    ...
    <div className={`Mission_content relative px-m mt-l text-white pt-xl bg-contect_bg_color transition-all duration-1000 ease-in-out transform opacity-${opacity} ${opacity ? 'bottom-0' : 'bottom-[-200px]'}`}>
      ...
      <InfoField description_side = 'r' animation = {supportAnimationData} description = "Server Byte offers exceptional customer support, available around the clock. 
    ...
    <InfoField description_side = 'l' animation = {mobileAnimationData} description = "With ServerByte, you can securely connect to your servers using SSH directly from your mobile device. 
            This feature ensures that you have the flexibility to perform critical 
            tasks and manage your infrastructure on the go."/>

    <InfoField description_side = 'r' animation = {customAnimationData} description = "Server Byte provides you with the opportunity to select a custom build at an affordable price. 
              With just a few clicks, you can configure your environment to meet your specific needs."/>

    <InfoField description_side = 'l' animation = {affordableAnimationData} description = "At ServerByte, we believe that cutting-edge technology should be accessible to everyone. 
    ...
    <InfoField description_side = 'r' animation = {trafficAnimationData} description = "Our servers come with unlimited traffic capabilities, allowing you to transfer data without any restrictions. 
