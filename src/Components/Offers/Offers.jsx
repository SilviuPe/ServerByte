...
function Mission() {
    ...
    return (
    <div className={`Mission_content relative px-m text-white pt-xl bg-contect_bg_color transition-all duration-1000 ease-in-out transform opacity-${opacity} ${opacity ? 'bottom-0' : 'bottom-[-200px]'}`}>
